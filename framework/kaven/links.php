...
<p>时间：<?php past_date() ?></p><p>来源： <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><?php the_permalink() ?> | <?php bloginfo('name');?></a></p></div><div id="workqr"><p class="itemfoot"><a class="yyicon2 yy2dian" href=""></a><span class="iftxt"><?php post_views(' ', ''); ?></span></p></div><div class="clear"></div></div>
